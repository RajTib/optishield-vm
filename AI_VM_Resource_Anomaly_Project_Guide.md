...
*(Grounding note: recent literature — including Isolation Forest/One-Class SVM approaches to VM workload anomaly detection, and cryptojacking-specific ML detection studies published in 2024–2025 — confirms these are active, still-open research directions rather than solved problems, which supports a solid related-work section. See sources at the end of this document.)*
...
## Appendix C — Related Work Pointers

- Detecting Anomalies in the Virtual Machine Using Machine Learning Techniques (Springer)
- Ensemble of Random and Isolation Forests for Graph-Based Intrusion Detection in Containers (arXiv 2306.14750)
- Detection of Cryptojacking Threats by Using Machine Learning within Cloud Server Environments (Spectrum of Engineering Sciences)
- Robust IoT security using Isolation Forest and One-Class SVM algorithms (PMC)
- Workload forecasting and resource management models based on machine learning for cloud computing environments (arXiv 2106.15112)

Use these as starting points for your literature review / related-work section — pull the full citations from the original sources when you write your final report.
